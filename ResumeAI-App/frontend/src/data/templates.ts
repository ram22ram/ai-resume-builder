...
export const TEMPLATES: TemplateConfig[] = [
    ...
    { id: 'modern_dark', name: 'Dark Mode Print', thumbnail: 'classic', isPremium: false, category: 'modern', layout: 'single', defaultFont: 'Inter', defaultColor: '#111827', structure: ['personal', 'experience', 'projects', 'skills', 'education'] }, // Ideally dark bg, light text. For now just dark accent.
