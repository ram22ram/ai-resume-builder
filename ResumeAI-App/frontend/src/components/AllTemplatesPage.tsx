      ...
      <Box sx={{ py: 6, bgcolor: '#ffffff', borderTop: '1px solid #e2e8f0', textAlign: 'center', mt: 8 }}>
        <Container maxWidth="lg">
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 1, mb: 2 }}>
              <Box component="img" src="./public/favicon.svg" alt="Logo" sx={{ width: 32, height: 32, borderRadius: '8px', objectFit: 'cover' }} />
              <Typography variant="h6" sx={{ fontWeight: '800', color: '#1e293b' }}>Resume<span style={{ color: '#7c3aed' }}>AI</span></Typography>
            </Box>
            <Typography variant="caption" color="text.secondary">© 2025 ResumeAI Builder. <br/>All rights reserved.</Typography>
        </Container>
      </Box>
    </Box>
  );
